...
class _ManiFestState extends State<ManiFest> {
  ...
  void _handleLogin() async {
    ...
    var data = {
        'manifest_code' : firstNameController.text,
        'document_type' : lastNameController.text,
        'sector' : mailController.text,
        'document_code' : passwordController.text,
        'client' : phoneController.text,
    };

    var res = await CallApi().postData(data, 'manifest');
